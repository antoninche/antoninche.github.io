...
const projects = [
  {
    ...
    desc:
      "Recréation du jeu Défi Nature en Python avec interface Pygame + plusieurs stratégies de robots et un module de simulations statistiques.",
    ...
    highlights: [
      "Interface complète + historique",
      "Stratégies heuristiques et probabilistes",
      "Architecture moteur / UI séparés",
    ],
  },
  {
    title: "Noob-Note — Gestion scolaire (Flask + SQLite)",
    desc:
      "Plateforme de gestion scolaire type PRONOTE : notes, moyennes, rangs. Architecture web dynamique, logique métier POO et base SQLite.",
    ...
    highlights: ["Dashboard prof", "Structure web propre", "Données centralisées"],
  },
  {
    title: "Bot Discord — Modulaire & stable (discord.py 2.x)",
    desc:
      "Bot Discord en Python : architecture modulaire, config validée au démarrage, logs clairs, commandes utiles. Inclut un site de doc GitHub Pages.",
  ...
  },
  {
    ...
    desc:
      "Site vitrine statique réutilisable : bistro / gastro / street en 1 clic avec thème persisté entre les pages.",
    tags: ["HTML", "CSS", "JavaScript"],
    repo: "https://github.com/antoninche/site-restaurant",
    cover: "https://opengraph.githubassets.com/1/antoninche/site-restaurant",
    highlights: ["3 ambiances", "Persistance du thème", "Base réutilisable client"],
  },
];
...
$("#copyBtn")?.addEventListener("click", async (e) => {
  ...
  try{
    ...
    setTimeout(() => (e.currentTarget.textContent = "Copier mon @GitHub"), 1200);
  } catch {
